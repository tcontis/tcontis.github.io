...
{% include figure.liquid loading="eager" path="assets/img/wire_bundle.jpg" class="img-fluid rounded z-depth-1" max-width="50%" %}
<div class="caption">
...
{% include figure.liquid loading="eager" path="assets/img/control_pad.png" class="img-fluid rounded z-depth-1" max-width="50%" %}
<div class="caption">
...
## Demo
{% include video.liquid path="https://www.youtube.com/embed/ptiaEEuiNBE" class="img-fluid rounded z-depth-1" min-width="50%" %}
